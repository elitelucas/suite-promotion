...
(function ($, window, document, undefined) {
    ...
    millery.prototype = {
        /////////////////////////////////////////////////////////////////////
        // assets properties that can be set through plugin initialization //
        /////////////////////////////////////////////////////////////////////
        public: function () {
            return {
        ...
        appendColumnUL: function (rootNode) {
            ...
            var i = this.columnscontainer.find(".millery-column").length,
                columnElement = $([
                    ...
                    (this.config.showHeaders ?
                        "<div class='millery-column-header'>" +
                        (rootNode.children("a").length > 0 ? rootNode.children("a").first().text() : this.getText(rootNode)) +
                        "</div>" : ""),
        ...
        attachEvents: function () {
            $(document).off("click.millery").on("click.millery", ".millery-node", function () {
                ...
                if ($(this).hasClass("millery-node-active") && allColumns.length > currentColumnIndex + 1) {
                ...
                instance.removeColumn(currentColumnIndex + 1).done(function () {
                    ...
                    if ($this.hasClass("millery-node-parent")) {
                        ...
                        if (instance.config.onnodeclick(instance, $this, $this.data("millery-data")) == true) {
                            instance.openPanel();
                        }
                        instance.globals.clickEventFinished.resolve();
        ...
        loadData: function (index, id, obj) {
            ...
            if (this.config.source != null) {
                ...
                if (this.config.columns[index]) {
                    ...
                    return $.getJSON(sourceUrl, $.proxy(
                        function (data) {
