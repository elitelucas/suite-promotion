	...
	<div class="tab-pane fade show active" id="earn" role="tabpanel" aria-labelledby="earn-tab">
		...
		<!--================================================== DRAG-DELETE DEMO ==================================================-->				
          ...
          <section class="connectedSortable">
            ...
            <!-- DIRECT CHAT -->
            <div style="border: 1px solid #eee;" class="card direct-chat direct-chat-default">
			...
			<a class="info-box collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseshare-and-visit1" aria-expanded="false">
				<span id="facebook" class="info-box-icon bg-info"><i class="fab fa-facebook"></i></span>

				<div class="info-box-content">
					<span class="info-box-text">Share and visit action - drag and delete demo</span>
				</div>
				
				<span id="action-point-share-and-visit-facebook" class="badge badge-danger float-right">+10</span>
				<!-- /.info-box-content -->
			</a>
			<!-- /.info-box -->

			<div id="collapseshare-and-visit1" class="panel-collapse collapse" style="">
				<div class="card-body">
				...
				<br>
					...
					<a id="action2" href="javascript:void(0);" style="color: #fff; " class="btn btn-block btn-social btn-facebook sharefbshare-and-visit">
						<i class="fab fa-facebook fa-2x"></i> Share our page</a>

					<div id="FBLikeshare-and-visit" style="display:none;-webkit-transition: width , height;transition: width , height;-webkit-transition-delay: 10s;transition-delay: 10s;" class="collapse text-center">

						<p id="message-description-share-and-visit"><i class="fas fa-check"></i> Thanks for sharing, visit our page to add points!</p>

						<p><a href="javascript:void(0);" style="color: #fff;" class="btn btn-block btn-social btn-facebook openFbAddPointshare-and-visit">
								<i class="fab fa-facebook fa-2x"></i> Share and Visit Facebook</a></p>
			...
			<a class="info-box collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseshare-and-visit2" aria-expanded="false">
				<span id="facebook" class="info-box-icon bg-info"><i class="fab fa-facebook"></i></span>
			...
			<div id="collapseshare-and-visit2" class="panel-collapse collapse" style="">
				<div class="card-body">
