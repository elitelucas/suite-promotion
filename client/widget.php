  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item">
        <div class="btn-group">
                    <button type="button" class="btn btn-danger btn-lg"><i class="fas fa-money-bill"></i> <b>5</b> Credits</button>
                    <button type="button" class="btn btn-danger btn-lg dropdown-toggle dropdown-icon" data-toggle="dropdown">
                      <span class="sr-only">Toggle Dropdown</span>
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="#"><i class="fas fa-money-bill"></i> Buy 10 credits (£10)</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-money-bill"></i> Buy 20 credits (£20)</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-money-bill"></i> Buy 30 credits (£30)</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-money-bill"></i> Buy 40 credits (£40)</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-money-bill"></i> Buy 50 credits (£50)</a>						
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="fas fa-sign-in-alt"></i> Register/Login</a>
                      </div>
                    </button>
                  </div>
...
<div class="col-12 col-sm-12 col-md-12">
		...
		<div class="alert alert-danger alert-dismissible text-center">
                  <h5><i class="icon fas fa-clock"></i> Choose days!</h5>
						<div class="form-group">
							<select class="form-control" name="type" id="time" required>
								<option value="3-days">3 day campaign - FREE</option>
								<option value="7-days">7 day campaign - 7 credits</option>
								<option value="14-days">14 day campaign - 14 credits</option>
								<option value="30-days">30 day campaign - 30 credits</option>
								<option value="60-days">60 day campaign - 60 credits</option>
							</select>
						</div>	
					<p>You don't have enough credits! <a href="javascript:void(0);" data-toggle="modal" data-target="#modal-credits">Click here to purchase</a></p>		
                </div>
...
<!--                                                    <label>We'd love to know about what type of campaign you'd like to run on Facebook, just let us know & we can see if we can help out.</label>-->
									...
									<div id="submit-and-share-<?php echo "$socialKey-$network"?>" style="display:none;-webkit-transition-delay: 2s;transition-delay: 2s;" class="collapse text-center" >
										<p><i class="fas fa-check"></i> Thanks for submitting, complete action to add points!</p>
						...
						<div class="card card-default">
							...
							<div id="collapse<?php echo $socialKey?>" class="panel-collapse collapse">
								<div class="card-body">
									...
									<div style="display: none" class="collapse text-center" id="action-content-<?php echo "$socialKey-$network";?>">
										<p id="message-description-<?php echo $socialKey?>"><i class="fas fa-check"></i> Thanks for submitting, points have been added!</p>
									</div>
									<!-------------------- / REVEAL -------------------->
								</div>
							</div>
							...
							<div id="collapse<?php echo $socialKey?>" class="panel-collapse collapse in">
								<div class="card-body">
									...
									<div style="display: none" class="collapse text-center" id="action-content-<?php echo "$socialKey-$network";?>">
										...
										<p id="message-description-<?php echo $socialKey?>"><i class="fas fa-check"></i> Thanks for visiting, complete action to add points!</p>
								...
								var popupCheck = setInterval(function() {
									...
									if(fraudCheck == 'no') {
										...
										setTimeout(function() {
											// add point to account here
											$('.sharefb<?php echo "$socialKey-$network";?>').hide();
											$('#message-description-<?php echo $socialKey?>').html('<i class="fas fa-check"></i> Thanks, points have been added!');
											$('#action-point-<?php echo "$socialKey-$network"?>').html('<i class="fas fa-check"></i>').removeClass('badge-danger').addClass('badge-default');
											updateTotalPoint(<?php echo (int)$numpoint?>);
							...
							<div id="collapse<?php echo $socialKey?>" class="panel-collapse collapse">
								<div class="card-body">
									...
									<div id="FBLike<?php echo $socialKey?>" style="display:none;-webkit-transition: width , height;transition: width , height;-webkit-transition-delay: <?php echo $delayTime?>s;transition-delay: <?php echo $delayTime?>s;" class="collapse text-center" >
										...
										<p id="message-description-<?php echo $socialKey?>"><i class="fas fa-check"></i> Thanks, complete action to add points!</p>
									...
									var popupCheck = setInterval(function() {
										...
										if(fraudCheck == 'no') {
											...
											setTimeout(function() {
												...
												$('#message-description-<?php echo $socialKey?>').html('<i class="fas fa-check"></i> Thanks for visiting, points have been added!');
...
<!--                                                        <textarea class="form-control" rows="3" placeholder="Enter comment"></textarea>-->
									...
									<div id="FBSelectShare<?php echo $socialKey?>" style="-webkit-transition-delay: 3s;transition-delay: 3s;" class="collapse text-center">
										...
										<p id="message-description-<?php echo $socialKey?>"><i class="fas fa-check"></i> Thanks, points have been added!</p>
									...
									<div id="scratchContainer<?php echo $socialKey; ?>" class="row">
										<div id="<?php echo $id?>"  class="scratch-container ">
											...
											<div class="form form<?php echo $socialKey;?> text-center" style="visibility: hidden;">
												<h2>YOU WON!</h2>
												<h4>Complete action to add points!</h4>
												<br>
												<div>
													<a id="action7"
													   href="javascript:void(0);"
						...
						<div class="card card-default">
							...
							<div id="collapse<?php echo $socialKey?>" class="panel-collapse collapse">
								<div class="card-body">
									...
									<div class="col-12 col-md-12 text-center" id="share-container<?php echo $socialKey;?>" style="display: none;">
										<p><i class="fas fa-check"></i> Thanks for playing, complete action to add points!</p>
										<a id="action2" href="javascript:void(0);" style="color: #fff; " class="btn btn-block btn-social btn-facebook sharefb<?php echo $socialKey?>">
											<i class="fab fa-facebook fa-2x"></i> <?php echo $shareAction;?></a>
									</div>
									<div id="FBLike<?php echo $socialKey?>" style="display:none;-webkit-transition: width , height;transition: width , height;-webkit-transition-delay: <?php echo $delayTime?>s;transition-delay: <?php echo $delayTime?>s;" class="collapse text-center" >
						...
						<div class="card card-default">
							...
							<div id="collapse<?php echo $socialKey?>" class="panel-collapse collapse">
								<div class="card-body">
									...
									<div class="col-12 col-md-12 text-center" id="share-container<?php echo $socialKey;?>" style="display: none;">
										<p><i class="fas fa-check"></i> Thanks for recording, complete action to add points!</p>
										<a id="action2" href="javascript:void(0);" style="color: #fff; " class="btn btn-block btn-social btn-facebook sharefb<?php echo $socialKey?>">
											<i class="fab fa-facebook fa-2x"></i> <?php echo $shareAction;?></a>
									</div>
									<div id="FBLike<?php echo $socialKey?>" style="display:none;-webkit-transition: width , height;transition: width , height;-webkit-transition-delay: <?php echo $delayTime?>s;transition-delay: <?php echo $delayTime?>s;" class="collapse text-center" >
...
<div id="tempActionBox" style="display:none">
	...
	<div class="d-none" id="scratchContainer">
		<div class="form-group">
			<label for="scratchUrl">Enter URL</label>
			<input type="text" class="form-control" name="scratchUrl" id="scratchUrl" aria-describedby="helpIdUrl" placeholder="E.g. your website or social profile">
		</div>
	</div>
	<div class="d-none" id="urlContainer">
		<div class="form-group">
			<label for="url">Enter URL </label>
			<input type="text" class="form-control" name="url" id="url" aria-describedby="helpIdUrl" placeholder="E.g. your website or social profile">
		</div>
		<div class="form-group">
	...
	<div class="form-group">
		<label for="visitAction">Action Name (Widget) - <a href="javascipt:void(0);" data-toggle="modal" data-target="#modal-visit"><u>VIEW IDEAS</u></a></label>
		<input type="text"
	...
	<div class="form-group">
		<label for="shareAction">Share/Follow Name (Button) - <a href="javascipt:void(0);" data-toggle="modal" data-target="#modal-share"><u>VIEW IDEAS</u></a></label>
		<input type="text"
			class="form-control" name="shareAction" id="shareAction"
			aria-describedby="helpIdShareAction"
			placeholder="E.g. Share our website">
	</div>	
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header text-center">
              <h4 class="modal-title">Purchase credits for campaign days, social actions and tools</h4>
