...
// Link
$link = getLink($referralId);
if (@$link->networks != null)
	$networks = $link->networks;
if (@$link->actions != null) {
	$newarr = [];
	foreach ($allPlugins as $obj) {
		if (in_array($obj['type'], $link->actions))
...
<![endif]-->
	...
	<!-- Spin Wheel (JS) -->
	<!--<script src="--><?php //echo PATH_ROOT 
						?>
	<!--/mockup/plugins/spin-wheel/js/jquery-2.1.1.js"></script>-->
		...
		<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
			<div class="container">
				<a href="https://suite.social/promo" class="navbar-brand">
					<img src="<?php echo PATH_ROOT ?>/images/logos/suite.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
						...
						<div class="col-12 col-sm-12 col-md-6" id="clientForm">
							...
							<input type="file" id="brand_pic_upload" name="brand_pic_upload" class="input-file" accept=".jpg,.jpeg,.png,.gif,.bmp"><!--<div id="file_name_0"></div>-->
																	...
																	<ul data-title='<?= $network ?>'>
																		...
																		?>
																					<li>
																						...
																						<div class="content" filename="<?php echo $plugin['filename']; ?>" actionname="<?php echo $plugin['actionName']; ?>" colorid="<?= $plugin['id'] ?>" iconid="<?= $plugin['iconid'] ?>">
																						</div>
																					</li>
																		<?php
																				}
											...
											<div class="card-custom card card-default">
												...
												<a class="info-box-custom info-box" data-toggle="collapse" data-parent="#accordion" href="#collapse5">
									...
									<div class="card-body login-card-body">
										...
										<?php if ($referralId == null) { ?>
											<?php if ($brandMedia['mode'] == 'video') { ?>
												<p>
													<div class="video-container embed-responsive embed-responsive-16by9"><iframe src="<?php echo $brandMedia['url']; ?>" frameborder="0" allowfullscreen class="video"></iframe></div>
												</p>
											...
											<?php } ?>
										<?php } else { ?>
											<p id="bannerpreview"><img style="margin-top:12px" id="banner_image" width="100%" src="<?= @$link->imageURL ?>" /></p>
										<?php } ?>
										...
										<div style="padding-left: 20px;padding-right: 20px;">
											...
											<div id="info" class="collapse">
												<br>
												<p class="login-box-msg descriptionbox"><?php echo $description; ?></p>
											</div>
																					...
																					$(document).on('click', '.sharefb<?php echo "$socialKey-$network"; ?>', function() {
																						...
																						var popupCheck = setInterval(function() {
																							...
																							if (fraudCheck == 'no') {
																								...
																								setTimeout(function() {
																									// add point to account here
																									//$('.sharefb<?php //echo "$socialKey-$network";
																													?>//').hide();
																			...
																			<?php } else if ($type == 'share-then-submit') { ?>
																				...
																				<div class="card card-default">
																					<a class="info-box" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $socialKey ?>">
																						...
																						<span id="action-point-<?php echo "$socialKey-$network" ?>" class="badge badge-danger float-right">
																							+<?php echo $numpoint ?>
																						</span>
																						<!-- /.info-box-content -->
																					</a>
																						...
																						<div class="card-body">
																							...
																							<?php if ($embedcode != '') : ?>
																								...
																								<div id="share-and-submit-<?php echo "$socialKey-$network" ?>" style="display:none">
																									<a id="action5" href="javascript:void(0);" style="color: #fff; -webkit-transition-delay: 3s;transition-delay: 3s;" class="btn btn-block btn-social btn-<?php echo $id ?> sharefb<?php echo "$socialKey-$network"; ?>" data-toggle="collapse" aria-expanded="false" aria-controls="FBLike">
																					...
																					<div id="collapse<?php echo $socialKey ?>" class="panel-collapse collapse in">
																						<div class="card-body">
																							...
																							<?php if ($embedcode != '') : ?>
																								...
																								<a id="action-<?php echo "$socialKey-$network"; ?>" href="javascript:void(0);" style="display:none;color: #fff; -webkit-transition: width , height;transition: width , height;-webkit-transition-delay: <?php echo $delayTime ?>s;transition-delay: <?php echo $delayTime ?>s;" class="btn btn-block btn-social btn-<?php echo $id ?>" data-toggle="collapse" aria-expanded="false" aria-controls="FBLike<?php echo $socialKey ?>">
																									<i class="fab fa-<?php echo $id ?> fa-2x"></i> <?php echo $shareAction ?></a>
																							<?php else : ?>
																								<a id="action-<?php echo "$socialKey-$network"; ?>" href="javascript:void(0);" style="color: #fff; -webkit-transition: width , height;transition: width , height;-webkit-transition-delay: <?php echo $delayTime ?>s;transition-delay: <?php echo $delayTime ?>s;" class="btn btn-block btn-social btn-<?php echo $id ?>" data-toggle="collapse" aria-expanded="false" aria-controls="FBLike<?php echo $socialKey ?>">
																									<i class="fab fa-<?php echo $id ?> fa-2x"></i> <?php echo $shareAction ?></a>
																							<?php endif; ?>
																							<div style="display: none" class="collapse text-center" id="action-content-<?php echo "$socialKey-$network"; ?>">
																							...
																							<div id="action6" class="row">
																								...
																								?>
																											<div class="col-6 col-md-6">
																												<a href="#FBSelectShare<?php echo $socialKey ?>" id="<?php $picture['name'] ?>" onclick="shareImage('<?php echo $picture['url']; ?>', '<?php echo $picture['mode']; ?>')" style="-webkit-transition-delay: 3s;transition-delay: 3s;" data-toggle="collapse" aria-expanded="false" aria-controls="FBSelectShare<?php echo $socialKey ?>" class="sharefb<?php echo $socialKey ?>">
																										...
																										?>
																											<div class="col-6 col-md-6">
																												<a href="#FBSelectShare<?php echo $socialKey ?>" onclick="shareImage('<?php echo $picture['url']; ?>', '<?php echo $picture['mode']; ?>')" style="-webkit-transition-delay: 3s;transition-delay: 3s;" data-toggle="collapse" aria-expanded="false" aria-controls="FBSelectShare<?php echo $socialKey ?>" class="sharefb<?php echo $socialKey ?>">
																													<img class="img-fluid mb-3" src="<?php echo $picture['mode'] == 'upload' ? PATH_ROOT . '/' . $picture['url'] : $picture['url']; ?>" alt="<?php echo $picture['name']; ?>">
																												</a>
																											</div>
																										<?php } ?>
																				...
																				<div class="card card-default">
																					...
																					<div id="collapse<?php echo $socialKey ?>" class="panel-collapse collapse">
																						<div class="card-body">
																							...
																							<!--                                                    <p>Friends: --><?php //echo $count;
																																									?>
																							<!--</p>-->
																							<!--                                                    <p>Visitors: --><?php //echo count($visitors);
																																									?>
																							<!--</p>-->
																							<!--                                                </div>-->
																							<!-------------------- REVEAL -------------------->
																							...
																							<?php if ($referralId != $uniqueId) { ?>
																								<a id="action7" href="javascript:void(0);" style="color: #fff; " class="btn btn-block btn-social btn-facebook sharefb<?php echo $socialKey ?>">
																									...
																									success: function(data) {
																										...
																										if (success) {
																											...
																											//    $('.sharefb<?php //echo $socialKey
																																?>//').hide();
																											//    $('.friends--show').hide();
																											//    $('#FBLike<?php //echo $socialKey
																															?>//').show();
																											//    $('#action-point-<?php //echo "$socialKey-$network"
																																	?>//').html('<i class="fas fa-check"></i>').removeClass('badge-danger').addClass('badge-default');
																											//    updateTotalPoint(<?php //echo (int)$numpoint
																																	?>//);
																											//}, <?php //echo $delayTime
																													?>// * 1000);
																							...
																							<div id="scratchContainer<?php echo $socialKey; ?>" class="row">
																								<div id="<?php echo $id ?>" class="scratch-container ">
																									...
																									<div class="form form<?php echo $socialKey; ?> text-center" style="visibility: hidden;">
																										...
																										<br>
																										<div>
																											<a id="action7" href="javascript:void(0);" style="color: #fff; " class="btn btn-block btn-facebook sharefb<?php echo $socialKey ?>">
																												<?php echo $shareAction; ?>
																											</a>
																										</div>
																									</div>
																			...
																			<?php } else if ($type == 'play-then-share') { ?>
																					...
																					<div id="collapse<?php echo $socialKey ?>" class="panel-collapse collapse">
																						<div class="card-body">
																							...
																							<div id="gameContainer<?php echo $socialKey; ?>" class="text-center">
																								...
																								<div class="codegena_iframe codegena_iframe<?php echo $socialKey; ?>" onclick="onClickGame()" data-src="<?php echo $game['iframe']; ?>" style="height:350px;width:100%;" data-responsive="true" data-img="<?php echo $game['preview']; ?>" data-css="background:url('images/loading.gif') white center center no-repeat;border:0px;" data-Id="game" data-name="<?php echo $game['name'] ?>"></div>
																				...
																				<script>
																					...
																					$(document).on('click', '.codegena_iframe<?php echo $socialKey; ?>', function() {
																						...
																						setTimeout(function() {
																							//$('#gameContainer<?php //echo $socialKey; 
																												?>//').hide();
																							$('#share-container<?php echo $socialKey; ?>').show();
																						}, <?php echo $delayTime ?> * 1000);
																					})
																						...
																						<div class="card-body">
																							...
																							<div id="recordContainer<?php echo $socialKey; ?>" class="col-12 col-md-12 text-center">
																								<?php if ($recordType == 'audio') { ?>
																									<p>
																										<audio id="my_<?php echo $recordType . "_" . $socialKey; ?>" class="video-js vjs-default-skin <?php echo $recordType; ?>--bgcolor video--dimensions"></audio>
																									</p>
																								<?php } else { ?>
																									<p>
																										<video id="my_<?php echo $recordType . "_" . $socialKey; ?>" class="video-js vjs-default-skin <?php echo $recordType; ?>--bgcolor video--dimensions"></video>
																									</p>
																								<?php } ?>
																							...
																							if (fraudCheck == 'no') {
																								...
																								setTimeout(function() {
																									//$('#gameContainer<?php //echo $socialKey; 
																														?>//').hide();
																									$('#share-container<?php echo $socialKey; ?>').hide();
																									//$('#recordContainer<?php //echo $socialKey;
																															?>//').hide();
																									$('#FBLike<?php echo $socialKey ?>').show();
																									$('#action-point-<?php echo "$socialKey-$network" ?>').html('<i class="fas fa-check"></i>').removeClass('badge-danger').addClass('badge-default');
																									updateTotalPoint(<?php echo (int)$numpoint ?>);
												...
												<div class="gallery-card">
													<div class="gallery-card-body">
														<label class="block-check">
															...
															<input type="checkbox" class="selected--game" id="selected_game_<?= $plugin['filename'] ?>_<?= $game_idx; ?>" onchange="onSelectGame('<?= $item['name']; ?>', '<?= $item['iframe']; ?>', '<?= $item['preview']; ?>', '<?= $game_idx; ?>','<?= $plugin['filename'] ?>')">
			...
			<div class="modal-content">
				...
				<div class="text-center modal-body">
					...
					<div id="divB">
						...
						<br>
						<p><a style="color:#fff;" class="btn bg-gradient-danger btn-lg" href="//suite.social/promo"><i class="fas fa-credit-card"></i> Sign-up now for only £9.99!</a>
