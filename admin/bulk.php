						...
						<form action="" method="post" id="create-plugin">
							<div class="form-group">
								...
								<select multiple="" class="form-control" name="type" id="type" required>
									<option value="play-then-share">1. Play then Share</option>
									<option value="record-and-share">2. Record and Share</option>
									<option value="scratch-and-share">3. Scratch and Share</option>
									<option value="select-and-share">4. Select and Share</option>
									<option value="share-and-refer">5. Refer and Share</option>
									<option value="share-and-visit">6. Share and Visit</option>
									<option value="share-then-submit">7. Share then Submit</option>
									<option value="spin-and-share">8. Spin and Share</option>
									<option value="submit-then-share">9. Submit then Share</option>
									<option value="visit-and-share">10. Visit and Share</option>
								</select>
							</div>
							...
							<div class="form-group">
								<label for="network">Enter Network</label>
							...
							<div class="form-group has-success">
								<p>Second word</p>
								<input type="text" class="form-control form-control-success" required name="actionName" id="actionName" placeholder="share">							
								<small id="helpId" class="form-text text-muted">Ex: Facebook play and [share] OR Facebok play and [follow]</small>
							</div>						
							...
							<div class="form-group has-success">
								<p>Second word</p>
								<input type="text" class="form-control form-control-success" required name="filename" id="filename" placeholder="share">							
								<small id="helpId" class="form-text text-muted">Ex: Facebook-play-[share] OR Facebok-play-[follow]</small>
							</div>							
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?php echo htmlspecialchars($data['actionName']); ?></td>
