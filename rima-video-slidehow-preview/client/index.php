...
<div class="login-box">
  ...
  <div class="card">
	...
	<p id="bannerpreview"><img style="margin-top:12px" id="banner_image" width="100%" src="<?php echo PATH_ROOT ?>/images/banner.jpg"/>
	</p>
...
<script>
    ...
    $("#add_action_button").click(function(){
    	...
    	var scratchUrl = $("#url").val();
    	var visitAction = $("#visitAction").val();
    	var shareAction = $("#shareAction").val();
    	if(scratchUrl !="")
    	{
    		var fbbutton = '<a id="selector-action-btn-select-and-share-facebook" href="'+scratchUrl+'" style="color: #fff; -webkit-transition-delay: 3s;transition-delay: 3s;" class="btn btn-block btn-social btn-facebook" data-toggle="collapse" aria-expanded="false" aria-controls="submit-and-shareselect-and-share"><i class="fa fa-facebook"></i> '+shareAction+'</a>';
    	}else{
    		var fbbutton = "";
    	}
    	$('#action_result').next('.card-default').prepend('<div class="card card-default"><a class="info-box collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse9" aria-expanded="false"><span id="suite" class="info-box-icon bg-info"><i class="fas fa-award"></i></span><div class="info-box-content"><span class="info-box-text">'+visitAction+'</span></div><span class="badge badge-danger float-right">+'+numpoint+'</span></a><div id="collapse9" class="panel-collapse collapse" style=""><div class="card-body"><p>'+fbbutton+'</p></div></div></div>');
    });
